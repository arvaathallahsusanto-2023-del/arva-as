...
import { Network, ArrowLeft, Building2, Search, Share2, BookOpen } from "lucide-react";
      ...
      <header className="relative z-10 border-b border-white/5 bg-[#020409]/80 backdrop-blur-xl sticky top-0 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="relative hidden md:block">
            ...
            <input type="text" placeholder="Cari institusi/nama..." className="bg-[#0a0f18] border border-white/10 rounded-full py-2 pl-9 pr-4 text-sm w-64 focus:outline-none focus:border-cyan-500/50 text-white" />
          </div>
        </div>
      </header>
