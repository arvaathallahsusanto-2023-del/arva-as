...
export default function Mirofish() {
  return (
    <div className="min-h-screen bg-[#020409] text-white selection:bg-cyan-500/30 overflow-x-hidden" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      
      {/* Google Font */}
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap');
        html { scroll-behavior: smooth; }
        body { background-color: #020409; }
        .glow-cyan { box-shadow: 0 0 40px rgba(34,211,238,0.15); }
        .glow-text { text-shadow: 0 0 30px rgba(34,211,238,0.4); }
        .grid-bg {
